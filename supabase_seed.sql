...
('cap00001-0000-0000-0000-000000000001',
...
('cap00002-0000-0000-0000-000000000002',
...
('cap00003-0000-0000-0000-000000000003',
...
('cap00004-0000-0000-0000-000000000004',
...
('cap00005-0000-0000-0000-000000000005',
...
('q0000001-0000-0000-0000-000000000001', 'cap00001-0000-0000-0000-000000000001', 1,
...
('q0000002-0000-0000-0000-000000000002', 'cap00001-0000-0000-0000-000000000001', 2,
...
('q0000003-0000-0000-0000-000000000003', 'cap00001-0000-0000-0000-000000000001', 3,
...
('q0000004-0000-0000-0000-000000000004', 'cap00002-0000-0000-0000-000000000002', 1,
...
('q0000005-0000-0000-0000-000000000005', 'cap00002-0000-0000-0000-000000000002', 2,
...
('q0000006-0000-0000-0000-000000000006', 'cap00002-0000-0000-0000-000000000002', 3,
...
('q0000007-0000-0000-0000-000000000007', 'cap00003-0000-0000-0000-000000000003', 1,
...
('q0000008-0000-0000-0000-000000000008', 'cap00003-0000-0000-0000-000000000003', 2,
...
('q0000009-0000-0000-0000-000000000009', 'cap00003-0000-0000-0000-000000000003', 3,
...
('q0000010-0000-0000-0000-000000000010', 'cap00004-0000-0000-0000-000000000004', 1,
...
('q0000011-0000-0000-0000-000000000011', 'cap00004-0000-0000-0000-000000000004', 2,
...
('q0000012-0000-0000-0000-000000000012', 'cap00004-0000-0000-0000-000000000004', 3,
...
('q0000013-0000-0000-0000-000000000013', 'cap00004-0000-0000-0000-000000000004', 4,
...
-- CAP-2024-001
('a0000001-0000-0000-0000-000000000001', 'cap00001-0000-0000-0000-000000000001',
...
('a0000002-0000-0000-0000-000000000002', 'cap00001-0000-0000-0000-000000000001',
 'Electronic signature workflow',
 'Establish mandatory electronic co-signature workflow for supervisors in EHR',
 'IT Manager', '2024-03-14', 'In Progress', null),

('a0000003-0000-0000-0000-000000000003', 'cap00001-0000-0000-0000-000000000001',
...
-- CAP-2024-002
('a0000004-0000-0000-0000-000000000004', 'cap00002-0000-0000-0000-000000000002',
...
('a0000005-0000-0000-0000-000000000005', 'cap00002-0000-0000-0000-000000000002',
...
('a0000006-0000-0000-0000-000000000006', 'cap00002-0000-0000-0000-000000000002',
...
-- CAP-2023-015
('a0000007-0000-0000-0000-000000000007', 'cap00003-0000-0000-0000-000000000003',
...
('a0000008-0000-0000-0000-000000000008', 'cap00003-0000-0000-0000-000000000003',
...
('a0000009-0000-0000-0000-000000000009', 'cap00003-0000-0000-0000-000000000003',
...
-- CAP-2024-003
('a0000010-0000-0000-0000-000000000010', 'cap00004-0000-0000-0000-000000000004',
...
('a0000011-0000-0000-0000-000000000011', 'cap00004-0000-0000-0000-000000000004',
...
('a0000012-0000-0000-0000-000000000012', 'cap00004-0000-0000-0000-000000000004',
...
('a0000013-0000-0000-0000-000000000013', 'cap00004-0000-0000-0000-000000000004',
...
('em000001-0000-0000-0000-000000000001', 'cap00001-0000-0000-0000-000000000001',
...
('em000002-0000-0000-0000-000000000002', 'cap00001-0000-0000-0000-000000000001',
...
('em000003-0000-0000-0000-000000000003', 'cap00002-0000-0000-0000-000000000002',
...
('em000004-0000-0000-0000-000000000004', 'cap00003-0000-0000-0000-000000000003',
...
('em000005-0000-0000-0000-000000000005', 'cap00004-0000-0000-0000-000000000004',
...
('em000006-0000-0000-0000-000000000006', null,
...
('em000001-0000-0000-0000-000000000001', 'CAP-2024-001_Results.pdf'),
('em000001-0000-0000-0000-000000000001', 'Findings_Detail.pdf'),
('em000002-0000-0000-0000-000000000002', 'Response_Plan_CAP-2024-001.pdf'),
('em000003-0000-0000-0000-000000000003', 'CAP-2024-002_Results.pdf'),
('em000004-0000-0000-0000-000000000004', 'CAP-2023-015_Results.pdf'),
('em000005-0000-0000-0000-000000000005', 'CAP-2024-003_Results.pdf'),
('em000005-0000-0000-0000-000000000005', 'MHP274_Findings_Detail.pdf');

-- ── NOTES ────────────────────────────────────────────────────
insert into public.notes (cap_id, author_id, author_name, body, created_at) values

('cap00001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'R. Patel',
...
('cap00001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000005', 'Admin',
 '30-day response submitted to DHCS on Feb 13. Awaiting acknowledgement from NAOS.',
 '2024-02-14 09:00:00+00'),

('cap00002-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000005', 'Admin',
 'CAP received. Needs immediate assignment — 30-day deadline approaching. Escalating to BH Director.',
 '2024-02-01 08:15:00+00'),

('cap00003-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000002', 'L. Chen',
...
('cap00004-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000005', 'Admin',
